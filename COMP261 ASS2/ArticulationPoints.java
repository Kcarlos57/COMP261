...
//        int time = 0;
//        Set<Stop> articulationPoints = new HashSet<>();
//        Map<Stop, Integer> discoveryTimes = new HashMap<>();
//
//        for (Stop stop : graph.getStops()) {
//            if (!discoveryTimes.containsKey(stop)) {
//                dfs(stop, null, discoveryTimes, articulationPoints, time);
//            }
//        }
//
//        return articulationPoints;
...
//        System.out.println("neighbours are " + currentStop.getNeighbours().size());
        for (Stop neighbour : currentStop.getNeighbours()) {
            if (!visited.contains(neighbour)) {
//                System.out.println("neighbour not visited");
                childCount++;
                time++;
